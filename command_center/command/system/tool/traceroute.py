...
and False otherwise.
"""
def echo_three(host, ttl, timeout):
    try1 = echo_one(host, ttl, timeout)
    try2 = echo_one(host, ttl, timeout)
    try3 = echo_one(host, ttl, timeout)
